                        ...
                        <form action="./allList" method="get" id="searchForm">
                            <div class="input-group w-100 mx-auto d-flex">
                                <select name="kind" class="form-select border-0 bg-light py-3">
                                    ...
                                    <option ${pager.kind eq 'v3'?'selected':''} value="v3">내용</option>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <c:forEach items="${allList}" var="d">
                                        <tr>
                                            <td><p class="mb-0 mt-4">${d.cookingNum}</p></td>
                                            <td><p class="mb-0 mt-4">${d.cookingContents}</p></td>
                                            <td><p class="mb-0 mt-4"><a href="/mycooking/detail?cookingNum=${d.cookingNum}">${d.cookingTitle}</a></p></td>
                                            <td><p class="mb-0 mt-4">${d.username}</p></td>
                                            <td><p class="mb-0 mt-4">${d.cookingGood}</p></td>
                                            <td><p class="mb-0 mt-4">${d.cookingHit}</p></td>
                                            <td><p class="mb-0 mt-4">${d.cookingDate}</p></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
