...
<article class="post-detail">
    ...
    <header class="post-header">
        ...
        <div class="post-meta">
            ...
            <span>작성일: ${dto.cookingDate}</span>
             <span>
                작성자:
                <a href="/member/user?username=${dto.username}" class="writer-link">
                    ...
                    <c:forEach items="${dto.list}" var="file">
                        <div class="image-box">
                            <img class="recipe-img"
                                 ...
                                 alt="요리 이미지">
                                 <label>
                    <input type="checkbox" name="deleteFileNums" value="${file.fileNum}">
                    삭제
                </label>
                        </div>
                    </c:forEach>
    ...
    <div class="post-actions">
        ...
        <a href="./update?cookingNum=${dto.cookingNum}" class="btn btn-update">수정</a>
        <a href="./delete?cookingNum=${dto.cookingNum}" class="btn btn-delete">삭제</a>
    </div>
