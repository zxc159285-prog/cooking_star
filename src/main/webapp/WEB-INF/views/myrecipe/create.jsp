                ...
                <div class="col-lg-7 mx-auto">
                    <form action="/myrecipe/create" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" readonly value="<sec:authentication property='principal.username'/>" name="username" class="w-100 form-control border-0 py-3 mb-4 bg-white">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">제목</label>
                            <input type="text" name="recipeTitle" class="w-100 form-control border-0 py-3 mb-4">
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="w-100 btn form-control border-secondary py-3 bg-white text-primary">저장</button>
                    </form>
                </div>
            </div>
        </div>
